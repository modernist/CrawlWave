...
namespace CrawlWave.ServerPlugins.Ebay
{
	...
	public class PluginSettings
	{
		...
		private EbayPluginSettings settings;
		...
		{
			string configFile = GetPluginPath()+"CrawlWave.ServerPlugins.Ebay.Config.xml";
			try
			{
				...
				XmlSerializer serializer=new XmlSerializer(typeof(EbayPluginSettings));
				settings=(EbayPluginSettings)serializer.Deserialize(ReadStream);
				ReadStream.Close();
			}
			catch
			{}
	...
	/// <summary>
	/// EbayPluginSettings provides a collection of all the settings required for the plugin's
	...
	/// </summary>
	[Serializable]
	public class EbayPluginSettings
	{
		/// <summary>
