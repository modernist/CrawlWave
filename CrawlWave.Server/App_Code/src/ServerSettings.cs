...
namespace CrawlWave.Server
{
	...
	public class ServerSettings
	{
		...
		{
			return connectionString + "Application Name =" + appName + rnd.Next().ToString() + ";Pooling = false";
		}
		...
		private void LoadSettings()
		{
			try
			{
				logLevel = (CWLogLevel)(int.Parse(ConfigurationSettings.AppSettings["LogLevel"]));
				dbLogOptions = (CWClientActions)(int.Parse(ConfigurationSettings.AppSettings["DBLogOptions"]));
				dataFilesPath = ConfigurationSettings.AppSettings["DataFilesPath"];
				string sqlServer = ConfigurationSettings.AppSettings["SQLServer"];
				string sqlLogin = ConfigurationSettings.AppSettings["SQLLogin"];
				string sqlPass = ConfigurationSettings.AppSettings["SQLPass"];
