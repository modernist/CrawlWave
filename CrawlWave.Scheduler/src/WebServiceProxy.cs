...
{
	/// <summary>
	/// WebServiceProxy is a Singleton class. TODO: switch to alternate, count failures
	/// </summary>
	...
	//    //        serverwse.RequestSoapContext.Security.Timestamp.TtlInSeconds = 3600;
	//    //        server.Timeout = 100000;
	//    //        serverwse.Timeout = 100000;
	//    //    }
	//    //    catch(Exception e)
	//    //    {
	//    //        if(globals.Settings.LogLevel <= CWLogLevel.LogWarning)
